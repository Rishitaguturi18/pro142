...
def popular_articles():
    ...
    popular_articles = df[["url", "title", "text", "lang", "total_events"]]
    return popular_articles.head(20)
    

# API to return top 10 similar articles using content based filtering method.
@app.route("/recommended-articles", methods=["GET"])
def recommended_articles():
    global recommended_articles 
    recommended_articles = df[["url", "title", "text", "lang", "total_events"]]
    return recommended_articles.head(20)
